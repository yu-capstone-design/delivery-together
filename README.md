...
* 사전에 정의한 데이터베이스 구조를 지키며 프로젝트를 진행하였습니다.
* 데이터베이스에 사용자의 개인정보를 넣을때 암호화를 진행하였습니다.
* 다양한 입력값을 토대로 테스트를 진행하여 결함을 줄이고자 노력하였습니다.
* 데이터베이스 접근을 최소화하도록 노력하였습니다.
...
* `Refactor` : 프로덕션 코드 리팩토링, 새로운 기능이나 버그 수정없이 현재 구현을 개선
